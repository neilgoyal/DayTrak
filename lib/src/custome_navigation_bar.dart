...
import 'package:schoolcalendar/src/animation/beacon_painter.dart';
import 'package:schoolcalendar/src/util/badge_text.dart';
...
class _CustomNavigationBarState extends State<CustomNavigationBar>
  ...
  void _startAnimation(int index) {
    ...
    Tween<double>(begin: 0.0, end: 0.0).animate(_curvedAnimation)
      ..addListener(() {
        setState(() {
