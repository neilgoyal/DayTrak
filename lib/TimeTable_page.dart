...
class TimeTable_page extends StatelessWidget {
  TimeTable_page({
    Key key,
  }) : super(key: key);
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: const Color(0xd4000000),
      body: Stack(
        children: <Widget>[
          Transform.translate(
          ...
          Transform.translate(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                border: Border.all(width: 1.0, color: const Color(0xbf39282f)),
              ),
            ),
          ),
          Transform.translate(
            offset: Offset(17.0, 523.0),
            child: Container(
              width: 332.0,
              height: 83.0,
              decoration: BoxDecoration(
          ...
          Transform.translate(
            offset: Offset(292.0, 122.0),
            child: Text(
              '8:00-\n9:00',
              style: TextStyle(
                fontFamily: 'Protipo Compact',
                fontSize: 20,
                color: const Color(0xff39282f),
                fontWeight: FontWeight.w100,
              ),
              textAlign: TextAlign.left,
            ),
