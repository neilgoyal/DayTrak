...
class Timetable_5Page extends StatefulWidget {
  @override
  _Timetable_5State createState() => _Timetable_5State();
}
...
// ignore: camel_case_types
class _Timetable_5State extends State<Timetable_5Page> {
  @override
  void initState() {
    super.initState();
    getIntValuesSF();
                                  ...
                                  title: Row(
                                    ...
                                    children: <Widget>[
                                      Expanded(
                                          child: Container(
                                        child: Text(
                                          blocktoprefrence(globals.timetable_5![
                                  ...
                                  title: Row(
                                    ...
                                    children: <Widget>[
                                      Expanded(
                                          child: Container(
                                        child: Text(
                                          (globals.timetable_5!.isNotEmpty)
