...
class Timetable_3Page extends StatefulWidget {
  @override
  _Timetable_3State createState() => _Timetable_3State();
}
...
class _Timetable_3State extends State<Timetable_3Page> {
  @override
  void initState() {
    super.initState();
    getIntValuesSF();
                                  ...
                                  title: Row(
                                    ...
                                    children: <Widget>[
                                      Expanded(
                                          child: Container(
                                        child: Text(
                                          blocktoprefrence(globals.timetable_3![
                                  ...
                                  title: Row(
                                    ...
                                    children: <Widget>[
                                      Expanded(
                                          child: Container(
                                        child: Text(
                                          (globals.timetable_3!.isNotEmpty)
