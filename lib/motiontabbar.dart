...
class _MotionTabBarState extends State<MotionTabBar>
  ...
  get index => labels.indexOf(globals.selectedTab);
  get position {
  ...
  void initState() {
    ...
    globals.selectedTab = widget.initialSelectedTab;
    activeIcon = icons[globals.selectedTab];
  ...
  List<Widget> generateTabItems() {
    return labels.map((tabLabel) {
      ...
      print(tabLabel);
      return TabItem(
        selected: globals.selectedTab == tabLabel,
        iconData: icon,
        title: tabLabel,
